  ...
  <div class="container">
    <div class="row"> 
      ...
      <div class="page-title-name">
          ...
          <p>Protegemos tus datos, tanto como si fueran los nuestros.</p>
        </div>
          <ul class="page-breadcrumb">
            <li><a href="./"><i class="fa fa-home"></i> Inicio</a> <i class="fa fa-angle-double-right"></i></li>
            <li><a href="#"><span>Política de privacidad</a></span> </li>
       </ul>
     </div>
   </div>
  </div>
    ...
    <div class="row">
     <div class="col-lg-12 col-md-12">
       <div class="action-box-text">
        <h3><strong> Radec design: </strong> Las plantillas de calidad que buscabas</h3>
        <p>Tratamos que tus esfuerzos se vean plasmados tal como lo imaginas y nosotros nos encargamos que pasen a online.</p>
      </div>
